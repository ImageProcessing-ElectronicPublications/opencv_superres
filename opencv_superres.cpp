...
// example_dnn_superres_dnn_superres image.png edsr 2 models/EDSR_x2.pb image_out.png
...
int main(int argc, char *argv[])
{
    ...
    if ( argc < 6 )
    {
        ...
        cout << "\t Arg 5: image_out | Path to image out" << endl;
        return -1;
    }
